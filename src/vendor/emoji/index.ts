...
export function emojiFromCodePoints(codePoints: number[]) {
  return codePoints.reduce((prev, cp) => prev + String.fromCodePoint(cp), '');
}

export {default as emojiRegExp} from './regex';
