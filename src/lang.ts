const lang = {
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on PhantomChat',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use PhantomChat app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts',
  ...
  'Deactivated.Subtitle': 'PhantomChat supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of PhantomChat.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give PhantomChat permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on PhantomChat. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on PhantomChat. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'PhantomChat is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use PhantomChat on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on PhantomChat. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on PhantomChat. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive PhantomChat Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive PhantomChat Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for PhantomChat Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, PhantomChat will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, PhantomChat automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, PhantomChat will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, PhantomChat automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, PhantomChat will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, PhantomChat automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, PhantomChat will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, PhantomChat automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by PhantomChat and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by PhantomChat and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by PhantomChat, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by PhantomChat, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by PhantomChat, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to PhantomChat Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** PhantomChat Premium subscription for %s',
    'other_value': '**%d** PhantomChat Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with PhantomChat Premium subscription for %s',
    'other_value': '**%d** %s with PhantomChat Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'PhantomChat Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'PhantomChat Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by PhantomChat.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by PhantomChat.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **PhantomChat Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to PhantomChat Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[PhantomChat Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[PhantomChat Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%1$s**, get **%2$d** more boost by gifting **PhantomChat Premium** to a friend.',
    'other_value': 'To boost **%1$s**, get **%2$d** more boosts by gifting **PhantomChat Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift PhantomChat Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[PhantomChat Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to PhantomChat Premium to restrict who can send you voice or video messages.\n\n**[What is PhantomChat Premium?]()**',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [PhantomChat Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[PhantomChat Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'PhantomChat doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **PhantomChat Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to PhantomChat Premium',
  ...
  'Frozen.Violation.Subtitle': 'Your account was frozen for breaking PhantomChat\'s Terms of Service.',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of PhantomChat.',
  'Verified.Channel': 'This channel was verified by PhantomChat.',
  'Verified.Group': 'This group was verified by PhantomChat.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [PhantomChat Premium]() to increase summary limits.',
  ...
  'PhantomChatPremiumSubscribedTitle': 'You are all set!',
  'PhantomChatPremiumSubscribedSubtitle': 'Thank you for subscribing to **PhantomChat Premium**.\nHere’s what is now unlocked.',
  'PhantomChatPremiumPeerTitle': '%s is a subscriber of **PhantomChat Premium**',
  'PhantomChatPremiumPeerSubtitle': 'Owners of **PhantomChat Premium** accounts have exclusive access to multiple additional features.',
  'PhantomChatPremiumPeerTitleEmojiStatus': '%s set this emoji from [%s]() as their current status.',
  'PhantomChatPremiumPeerTitleEmojiStatusNoPack': '%s set this emoji as their current status.',
  'PhantomChatPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **PhantomChat Premium**:',
  ...
  'ContactJoined': 'Contact joined PhantomChat',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on PhantomChat.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on PhantomChat only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **PhantomChat**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  'Notifications': 'Notifications',
  'Contact.Delete.Success': 'Contact deleted',
  'Contact.Delete.Failed': 'Failed to delete contact',
  'Contact.Delete.ChatNotReady': 'Chat is not ready yet',
  'Contact.Delete.CouldNotResolve': 'Could not resolve contact to delete',
  'Contact.Delete.ConfirmationDesc': 'will be deleted along with the entire conversation history. This cannot be undone.',
  'PhantomChat.GroupEdit.AdminSubtitle': 'admin',
  'PhantomChat.GroupEdit.GroupMembers': 'Group Members',
  'PhantomChat.GroupEdit.MakeAdmin': 'Make Admin',
  'PhantomChat.GroupEdit.MakeAdminDescription': 'Transfer admin rights to {0}? They will be able to edit the group, manage members and delete it.',
  'PhantomChat.GroupEdit.AdminLeaveHint': 'Admins can\'t leave the group. Transfer admin first, then leave.',
  'PhantomChat.GroupEdit.DeleteGroup': 'Delete Group',
  'PhantomChat.GroupEdit.DeleteGroupDescription': 'Delete this group for everyone? It will be removed for all members and cannot be undone.',
  'PhantomChat.GroupEdit.ChangePhoto': 'Change group photo',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your PhantomChat account. There will be no way to restore it.',
  ...
  'PhantomChatFeatures': 'PhantomChat Features',
  ...
  'NoUsernameFound': 'There is no PhantomChat account with this username.',
  ...
  'ReportSentInfo': 'PhantomChat moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official PhantomChat app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'PhantomChatFeaturesUrl': 'https://chat.phantomyard.ai/features',
  'ScamMessage': 'SCAM',
  'FakeMessage': 'FAKE',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. PhantomChat has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that PhantomChat never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **PhantomChat Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **PhantomChat Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with PhantomChat',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with PhantomChat?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with PhantomChat.',
  'TerminateWebSessionInfo': 'Click to disconnect from your PhantomChat account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **PhantomChat Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **PhantomChat Premium**.',
  ...
  'GiftPhantomChatPremiumTitle': 'Gift PhantomChat Premium',
  'GiftPhantomChatPremiumDescription': 'Give **%1$s** access to exclusive features with **PhantomChat Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive PhantomChat features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': 'PhantomChat will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has PhantomChat installed will be able to join your channel by following this link.',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with PhantomChat**. You must agree to the Terms of Use for mini apps to continue.',
  ...
  'PremiumNeededForBoosting': 'Only **PhantomChat Premium** subscribers can boost channels. Do you want to subscribe to **PhantomChat Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **PhantomChat Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of PhantomChat Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** PhantomChat Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s PhantomChat Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s PhantomChat Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s PhantomChat Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s PhantomChat Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **PhantomChat Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **PhantomChat Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **PhantomChat Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **PhantomChat Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **PhantomChat Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **PhantomChat Premium** subscription.',
  ...
  'BoostingDate': 'Date',
  'BoostingPhantomChatPremiumFor': 'PhantomChat Premium for %s',
  ...
  'BoostingPremium': 'PhantomChat Premium',
  'BoostingStars': 'PhantomChat Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **PhantomChat Premium**.',
  ...
  'PhantomChatPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to PhantomChat Premium.',
  'PhantomChatPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to PhantomChat Premium.',
  'PhantomChatPremiumUserGiftedPremiumDialogSubtitle': 'You now have access to additional features.',
  'PhantomChatPremiumUserGiftedPremiumOutboundDialogSubtitle': '**%1$s** now has access to additional features.',
  'GiftMonths': {
    'one_value': '%1$d-month',
    'other_value': '%1$d-months'
  },
  ...
  'GiftPremiumActivateErrorTitle': 'You already have PhantomChat Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to PhantomChat Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to PhantomChat Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a PhantomChat Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to PhantomChat Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to PhantomChat Premium',
  ...
  'AdHidden': 'You will no longer see ads from PhantomChat.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': 'PhantomChat Ads are very different from ads on other platforms. Ads such as this one:',
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': 'Ads on PhantomChat do not use your personal information and are based on the channel in which you see them.',
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from PhantomChat Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **PhantomChat Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can create an ad to display in this channel — with minimal budgets. Check out the **PhantomChat Ad Platform** for details. %1$s',
  ...
  'PhantomChatStars': 'PhantomChat Stars',
  'PhantomChatStarsInfo': 'Buy Stars to unlock content and services\nin mini apps on PhantomChat.',
  ...
  'MenuPhantomChatStars': 'My Stars',
  'MenuPhantomChatStarsTon': 'My TON',
  'StarsCount': {
    'one_value': '%d Star',
    'other_value': '%d Stars'
  },
  ...
  'FactCheckToast': 'This clarification was provided by PhantomChat.',
  'FactCheckFooter': 'This clarification was provided by PhantomChat.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **PhantomChat Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on PhantomChat.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on PhantomChat.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on PhantomChat.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on PhantomChat.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on PhantomChat.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on PhantomChat and Fragment over the past month.',
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastPhantomChat': 'This is the price at which **%s** was last sold on PhantomChat',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on PhantomChat and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on PhantomChat and Fragment over the past month.',
  'StarGiftViewResalePhantomChat': '%s for sale on PhantomChat %s',
  ...
  'PhantomChatStarsGift': 'Gift Stars to Friends',
  'StarsSentText': {
  ...
  'Reported2': 'PhantomChat moderators will review your report. Thank you!',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on PhantomChat yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using PhantomChat search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using PhantomChat search.',
  ...
  'Chat.Service.PeerJoinedPhantomChat': '%@ joined PhantomChat',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, PhantomChat never uses your private data to target ads. Sponsored messages on PhantomChat are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on PhantomChat sees the same sponsored messages.\n\nUnlike other apps, PhantomChat doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nPhantomChat offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, PhantomChat developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow PhantomChat to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to PhantomChat Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make PhantomChat look amazing.',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [PhantomChat Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through PhantomChat servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'PhantomChat.GeneralSettingsViewController': 'Interface Settings',
  'PhantomChat.InstalledStickerPacksController': 'Stickers',
  'PhantomChat.NotificationSettingsViewController': 'Notifications',
  'PhantomChat.LanguageViewController': 'Language',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your PhantomChat account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where PhantomChat sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to PhantomChat Premium.',
  ...
  'Premium.Boarding.Title': 'PhantomChat Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **PhantomChat Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to PhantomChat Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nPhantomChat Premium',
  'Premium.Boarding.Peer.Info': 'Owners of PhantomChat Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About PhantomChat Premium',
  'Premium.Boarding.About.Text': 'While the free version of PhantomChat already gives its users more than any other messaging application, **PhantomChat Premium** pushes its capabilities even further.\n\n**PhantomChat Premium** is a paid option, because most Premium Features require additional expenses from PhantomChat to third parties such as data center providers and server manufacturers. Contributions from **PhantomChat Premium** users allow us to cover such costs and also help PhantomChat stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the PhantomChat [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for PhantomChat Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have PhantomChat Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [PhantomChat Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [PhantomChat Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [PhantomChat Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [PhantomChat Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [PhantomChat Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to PhantomChat Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your PhantomChat.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock PhantomChat.',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of PhantomChat\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via PhantomChat instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on PhantomChat. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on PhantomChat. What affects it:',
  'StarsRating.Row1Title': 'Gifts from PhantomChat',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from PhantomChat.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive PhantomChat login codes via email and not SMS. Please enter an email address to which you have access.',
  ...
  'Update.Consent.PhaseDownloading': 'Downloading & verifying',
  'Update.Consent.PhaseInstalling': 'Installing update',
  'Update.Consent.PhaseFinalizing': 'Almost done…',
  ...
  'Update.Compromise.Todo2': 'Verify the version on github.com/phantomchat-chat/phantomchat-chat',
  'Update.Compromise.Todo3': 'Do not enter passwords or sensitive data',
  'Update.Compromise.CloseButton': 'Close application',
  'Update.Compromise.Recovery.Note': 'Are you sure you are NOT under attack? If this alert appeared after a legitimate update or a first-time Phase A install, you can reset the baseline and restart the app. The reset does NOT uninstall the app or erase your PhantomChat identity.',
