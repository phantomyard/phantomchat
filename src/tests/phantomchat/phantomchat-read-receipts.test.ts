/**
 * Tests for phantomchat-read-receipts.ts
 *
...
describe('phantomchat-read-receipts', () => {
  ...
  beforeEach(() => {
    ...
    (window as any).__phantomchatChatAPI = {markRead: mockMarkRead};
  });
  ...
  it('skips if no own pubkey', async() => {
    (window as any).__phantomchatOwnPubkey = undefined;
    await sender.sendForPeer(PEER_ID);
