 ...
 * Verifies that connection status reads from phantomchat_relay_state events
...
describe('ConnectionStatusComponent relay integration', () => {
  ...
  it('listens to phantomchat_relay_state events, not connection_status_change', () => {
    expect(registeredEvents.has('phantomchat_relay_state')).toBe(true);
