...
describe('phantomchat-reactions-receive', () => {
  let recv: any;
  let store: any;
  ...
  beforeEach(async() => {
    vi.resetModules();
    (globalThis as any).indexedDB.deleteDatabase('phantomchat-reactions');
    messageStoreMock = new Map();
    const recvMod = await import('@lib/phantomchat/phantomchat-reactions-receive');
    recv = recvMod.phantomchatReactionsReceive;
