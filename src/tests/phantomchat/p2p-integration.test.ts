/**
 * P2P chat rendering integration tests for PhantomChat.chat
 *
...
describe('generateFlags() for P2P virtual peers', () => {
   ...
   * When getSelf() returns undefined (PhantomChat.chat mode), fromId becomes 0
...
describe('P2P message finalization (empty updates for virtual peer)', () => {
   ...
   * When phantomchatIntercept returns empty updates for a P2P peer (peerId >= 1e15),
