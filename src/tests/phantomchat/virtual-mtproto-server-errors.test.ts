// @ts-nocheck
/**
 * Error-path + malformed-input tests for PhantomChatMTProtoServer.
 *
...
describe('PhantomChatMTProtoServer — error + malformed input paths', () => {
  let server: any;
  let warnSpy: any;
  ...
  it('sendMessage: chatAPI.sendText rejection returns emptyUpdates (no throw)', async() => {
    ...
    // Neither phantomchatMid nor phantomchatEventId on the failure path
