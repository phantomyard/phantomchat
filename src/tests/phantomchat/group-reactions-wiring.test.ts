 ...
 * (phantomchat-reactions-publish), which p-tags only the reacted-to author.
...
vi.mock('@lib/phantomchat/group-store', storeMock);
vi.mock('@lib/phantomchat/nostr-crypto', cryptoMock);
vi.mock('@lib/phantomchat/group-control-messages', controlMock);
vi.mock('@lib/phantomchat/phantomchat-groups-sync', syncMock);
...
beforeAll(async() => {
  vi.resetModules();
  vi.doMock('@lib/phantomchat/group-store', storeMock);
  vi.doMock('@lib/phantomchat/nostr-crypto', cryptoMock);
  vi.doMock('@lib/phantomchat/group-control-messages', controlMock);
  vi.doMock('@lib/phantomchat/phantomchat-groups-sync', syncMock);
  vi.doMock('@lib/rootScope', () => ({default: {dispatchEvent: vi.fn(), addEventListener: vi.fn()}}));
  vi.doMock('@lib/logger', loggerMock);
  GroupAPI = (await import('@lib/phantomchat/group-api')).GroupAPI;
});
