...
import {parseQRPayload} from '@lib/phantomchat/qr-payload';
import {generateNostrIdentity} from '@lib/phantomchat/nostr-identity';
...
describe('parseQRPayload', () => {
  ...
  it('returns self error when npub matches own pubkey', () => {
    (window as any).__phantomchatOwnPubkey = VALID_HEX;
