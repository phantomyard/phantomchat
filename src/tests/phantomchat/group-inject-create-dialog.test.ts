...
let injectGroupCreateDialog: typeof import('@lib/phantomchat/phantomchat-groups-sync')['injectGroupCreateDialog'];
...
afterAll(() => {
  ...
  // mirror.test.ts in particular) can re-import `phantomchat-groups-sync`
