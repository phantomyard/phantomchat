...
import {encryptFile, decryptFile, bytesToHex, hexToBytes} from '@lib/phantomchat/file-crypto';

describe('file-crypto', () => {
  it('round-trips encrypt/decrypt', async() => {
    const plaintext = new TextEncoder().encode('hello phantomchat');
    ...
    expect(decryptedText).toBe('hello phantomchat');
  });
