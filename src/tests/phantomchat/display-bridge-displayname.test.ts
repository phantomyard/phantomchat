/**
 * Tests for phantomchat-display-bridge.ts — deriveDisplayName logic
 *
 * The method is private on PhantomChatDisplayBridge, so we replicate its logic
...
/**
 * Replicates the deriveDisplayName logic from PhantomChatDisplayBridge (line ~804).
