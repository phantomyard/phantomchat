/**
 * PhantomChat.chat E2E Tor-Wrapped Messaging Tests
 *
...
test.describe('PhantomChat.chat E2E Tor-Wrapped Messaging', () => {
  test('two-browsers-generate-identities-and-show-chat', async() => {
    ...
    await pageA.goto(
      `http://localhost:8080/phantomchat?peer=${encodeURIComponent(identityB.ownId)}`,
