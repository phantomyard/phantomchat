 ...
 * `sticker.sticker` unconditionally. In PhantomChat mode the reactions catalog
...
describe('reaction.ts guards tolerate undefined availableReaction (PhantomChat mode)', () => {
  it('early-returns when nothing is resolvable (PhantomChat stub catalog, no sticker, no genericEffect)', () => {
