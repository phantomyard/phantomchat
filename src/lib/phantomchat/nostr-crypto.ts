 ...
 * @param senderSk         - Sender's secret key (Uint8Array)
 * @param recipientPubHex  - Recipient's hex public key
 * @param content          - Typing lifecycle signal: '' (typing), 'stop', or 'recording'
 * @param conversationId   - Conversation identifier (recipient pubkey for 1:1, group ID for group)
 ...
 *
 * @param senderSk       - Sender's secret key
 * @param memberPubkeys  - Other group members' hex public keys (excluding sender)
 * @param content        - Typing lifecycle signal: '' (typing), 'stop', or 'recording'
 * @param groupId        - Group identifier
 * @returns Array of signed kind-1059 gift-wrap events (one per member)
 */
