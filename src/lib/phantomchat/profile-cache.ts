/*
 * PhantomChat.chat — Own profile cache
 *
...
const CACHE_KEY = 'phantomchat-profile-cache';
const LEGACY_EXTRAS_KEY = 'phantomchat-profile-extras';
...
export function loadCachedProfile(): CachedProfile | null {
  ...
  // {website, lud16} under phantomchat-profile-extras with no created_at.
