...
// Used for seed phrase generation
export const WORDLIST = [
  ...
  'birth', 'bitter', 'black', 'blade', 'blame', 'blanket', 'blast', 'blaze', 'bless', 'blind',
  ...
  'garbage', 'garden', 'gas', 'gasp', 'gate', 'gather', 'gauge', 'gaze', 'general', 'genius',
  ...
  'medal', 'media', 'melody', 'melt', 'member', 'memory', 'men', 'mend', 'mental', 'mentor',
  ...
  'palace', 'palm', 'panda', 'panel', 'panic', 'panther', 'pants', 'papa', 'paper', 'parade',
  ...
  'range', 'rapid', 'rare', 'rate', 'rather', 'raven', 'raw', 'reach', 'react', 'read',
  'real', 'realm', 'rear', 'reason', 'rebel', 'rebuild', 'recall', 'receive', 'recipe', 'record',
  'recycle', 'red', 'reduce', 'reflect', 'reform', 'refuse', 'region', 'regret', 'regular', 'reject',
  'relax', 'release', 'relief', 'rely', 'remain', 'remember', 'remind', 'remote', 'remove', 'render',
  'renew', 'reopen', 'repair', 'repeat', 'replace', 'reply', 'report', 'represent', 'reproduce', 'public',
  'request', 'require', 'rescue', 'resemble', 'resist', 'resource', 'response', 'result', 'retire', 'retreat',
  ...
  'room', 'rose', 'rotate', 'rough', 'round', 'route', 'royal', 'rubber', 'rubble', 'ruby',
  ...
  'sustain', 'swallow', 'swamp', 'swap', 'swarm', 'swear', 'sweat', 'sweep', 'sweet', 'swift',
