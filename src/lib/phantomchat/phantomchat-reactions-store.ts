 ...
 *
 * Schema — IDB `phantomchat-reactions`, store `reactions`:
...
const DB_NAME = 'phantomchat-reactions';
const STORE = 'reactions';
const DB_VERSION = 1;

class PhantomChatReactionsStore {
...
export const phantomchatReactionsStore = new PhantomChatReactionsStore();

if(typeof window !== 'undefined') {
  (window as any).__phantomchatReactionsStore = phantomchatReactionsStore;
}
