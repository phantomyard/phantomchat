/*
 * PhantomChat.chat -- Recovery Phrase UI
 *
...
export default class AppPhantomChatSeedPhraseTab extends SliderSuperTab {
  ...
  public init() {
    this.container.classList.add('phantomchat-seed-phrase-tab');
  ...
  private async handleReveal(): Promise<void> {
    try {
      ...
      const protectionType = usePhantomChatIdentity().protectionType();
