/**
 * AppPhantomChatTorDashboardTab — Tor circuit dashboard in sidebar
 *
...
export default class AppPhantomChatTorDashboardTab extends SliderSuperTab {
  ...
  public init() {
    ...
    rootScope.addEventListener('phantomchat_tor_circuit_update', onCircuitUpdate);
    rootScope.addEventListener('phantomchat_tor_state', onStateChange);
    ...
    (this as any).eventListener?.addEventListener('destroy', () => {
      ...
      rootScope.removeEventListener('phantomchat_tor_circuit_update', onCircuitUpdate);
      rootScope.removeEventListener('phantomchat_tor_state', onStateChange);
    });
