/**
 * PhantomChat.chat New Group Tab
 *
...
export default class AppPhantomChatNewGroupTab extends SliderSuperTab {
  ...
  public init({peerIds}: {peerIds: PeerId[]}) {
    ...
    attachClickEvent(this.nextBtn, async() => {
      ...
      try {
        ...
        // (phantomchat-groups-sync.ts). All that remains here is to open the chat.
        ...
        console.error('[AppPhantomChatNewGroupTab] createGroup error:', err);
        toggle();
      }
