/**
 * AppPhantomChatMeshSettingsTab — P2P mesh network settings
 *
...
const MESH_ENABLED_KEY = 'phantomchat-mesh-enabled';

export default class AppPhantomChatMeshSettingsTab extends SliderSuperTab {
  ...
  public async init() {
    ...
    rootScope.addEventListener('phantomchat_mesh_peer_connected' as any, () => this.renderMeshStatus());
    rootScope.addEventListener('phantomchat_mesh_peer_disconnected' as any, () => this.renderMeshStatus());
