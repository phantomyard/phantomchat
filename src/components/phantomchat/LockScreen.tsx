...
import {clearConversationKeyCache} from '@lib/phantomchat/nostr-crypto';
...
export default function LockScreen(): JSX.Element {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      rootScope.dispatchEvent('phantomchat_identity_unlocked', {
        npub: record.npub
      });
  ...
  function handleForgotPin() {
    ...
    rootScope.dispatchEvent('phantomchat_recovery_requested', undefined);
  }
