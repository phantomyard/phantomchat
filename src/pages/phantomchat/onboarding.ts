/*
 * PhantomChat.chat Onboarding — tweb auth-page style
 *
...
} from '@lib/phantomchat/key-storage';
import {needsMigration, migrateOwnIdToNpub} from '@lib/phantomchat/migration';
...
export class PhantomChatOnboarding {
  ...
  constructor() {
    ...
    this.container.className = 'phantomchat-onboarding';
  }
  ...
  private notifyIdentityCreated(): void {
    window.dispatchEvent(new CustomEvent('phantomchat-identity-created', {
  ...
  private showWelcome(): void {
    ...
    hero.classList.add('phantomchat-welcome-hero');
    ...
    title.classList.add('phantomchat-welcome-title');
  ...
  private showCreateResult(): void {
    ...
    npubBox.classList.add('phantomchat-npub-box');

    const npubLabel = document.createElement('div');
    npubLabel.classList.add('phantomchat-npub-label');
    npubLabel.textContent = 'YOUR PUBLIC KEY';

    const npubValue = document.createElement('div');
    npubValue.classList.add('phantomchat-npub-value');
  ...
  private showImport(): void {
    ...
    for(let i = 0; i < 12; i++) {
      ...
      field.classList.add('phantomchat-seed-field');

      const label = document.createElement('span');
      label.classList.add('phantomchat-seed-num');
      ...
      input.classList.add('phantomchat-seed-input');
    ...
    errorEl.classList.add('phantomchat-error');
  ...
  private showDisplayName(): void {
    ...
    avatarPreview.classList.add('phantomchat-avatar-preview');

    const avatarImg = document.createElement('img');
    avatarImg.classList.add('phantomchat-avatar-img');
