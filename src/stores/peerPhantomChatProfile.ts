...
import type {NostrProfile} from '@lib/phantomchat/nostr-profile';
...
function installListener() {
  ...
  rootScope.addEventListener('phantomchat_peer_profile_updated', ({peerId, profile}) => {
 ...
 */
export function usePeerPhantomChatProfile(peerId: PeerId): Accessor<NostrProfile | undefined> {
  installListener();
