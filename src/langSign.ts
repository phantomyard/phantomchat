const lang = {
  'Login.Title': 'Sign in to PhantomChat',
  ...
  'Login.Code.SentInApp': 'We have sent you a message in PhantomChat\nwith the code.',
  ...
  'Login.ResetEmail.Text': 'You can change your login email if you are logged into PhantomChat from another device.\n\nOtherwise, if you don\'t have access to this email, you can reset it with an **SMS** code in **%s**.',
  ...
  'Login.ResetEmail.NeedPremium': 'PhantomChat Premium Required',
  'Login.ResetEmail.NeedPremiumText': 'Due to the high cost of SMS in your country, you need a **PhantomChat Premium** account to immediately reset this email via an SMS code.\n\nYou can ask a friend to gift a Premium subscription for your account',
  ...
  'Login.QR.Title': 'Log in to PhantomChat by QR Code',
  'Login.QR.Help1': 'Open PhantomChat on your phone',
