const lang = {
  'Login.Title': 'Sign in to Nostra.chat',
  ...
  'Login.Code.SentInApp': 'We have sent you a message in Nostra.chat\nwith the code.',
  ...
  'Login.ResetEmail.Text': 'You can change your login email if you are logged into Nostra.chat from another device.\n\nOtherwise, if you don\'t have access to this email, you can reset it with an **SMS** code in **%s**.',
  ...
  'Login.ResetEmail.NeedPremium': 'Nostra.chat Premium Required',
  'Login.ResetEmail.NeedPremiumText': 'Due to the high cost of SMS in your country, you need a **Nostra.chat Premium** account to immediately reset this email via an SMS code.\n\nYou can ask a friend to gift a Premium subscription for your account',
  ...
  'Login.QR.Title': 'Log in to Nostra.chat by QR Code',
  'Login.QR.Help1': 'Open Nostra.chat on your phone',
